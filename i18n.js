...
const translations = {
  ...
  ja: {
    ...
    about: {
      ...
      intro: "紹介",
      introText:
        "私はこれまで、複数のプロジェクトにおいてUIアニメーションセクションのリードとして、ディレクション、マネジメント、進行管理を担当してまいりました。長年の経験と培ってきた技術力を活かし、プロジェクト全体の品質向上に貢献できたと自負しております。また、Webデザイナーおよびフロントエンドエンジニアとしての経験もあり、ゲーム開発現場ではエンジニアとの円滑なコミュニケーションや、実装レベルでのサポートも可能です。技術とデザイン、双方の視点を持っていることが私の強みです。マネジメント面では、職種リーダーやプロジェクトセクションのリード、新人育成など、さまざまな立場でマネジメントに携わってきました。その経験を活かし、チームのモチベーション維持やスムーズな進行管理にも自信があります。さらに、技術力とマネジメント経験に裏打ちされたコミュニケーション力も私の強みです。常に相手の立場に立った対話を心がけており、「話しやすい」と言っていただくことも多く、チーム内外との良好な関係構築にも寄与しています。",
      contact: "連絡先",
      interests: "関心分野",
      experience: "経歴",
      education: "教育",
